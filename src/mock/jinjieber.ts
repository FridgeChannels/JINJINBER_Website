export const jinjieberMock = {
  hero: {
    headline: "Engineering Flow. Delivering Trust.",
    /* subheadline: "Since 1988, Jinjieber has been a global leader in manufacturing high-performance valves and pumps for the world's most demanding industries — from oil fields to fire stations, from municipal waterworks to agricultural irrigation systems.", */
    subheadline: "Since 1988, Jinjieber has been a global leader in manufacturing high-performance valves for the world's most demanding industries — from oil fields to fire stations, from municipal waterworks to agricultural irrigation systems.",
    cta: [
      { label: "Request a Quote", href: "/contact" },
      { label: "Explore Products", href: "/products" }
    ],
    images: [
      "/placeholders/WhyChooseJJB/1casting.png",
  ...
  about: {
    ...
    whoWeAre: "Jinjieber is a world-class manufacturer and supplier of industrial valves and fluid control solutions. Founded in 1988, we bring over 35 years of engineering expertise, manufacturing excellence, and unwavering commitment to quality to customers across the globe.\n\nHeadquartered in China with strategic operations serving North America, Europe, and the Middle East, Jinjieber has grown from a specialized casting workshop into a fully integrated valve enterprise — trusted by engineers, contractors, and distributors on every continent.",
    ...
    pumps: [
      {
        ...
        description: "High-efficiency centrifugal pumps for water supply, irrigation, HVAC, and industrial process applications. Single-stage and multi-stage options with capacities up to 5,000 m³/h."
      },
      {
        slug: "fire-pumps",
        title: "Fire Pumps",
        image: "/placeholders/Product/p3.jpg",
        description: "UL/FM listed fire pump packages including end-suction, horizontal split-case, and vertical turbine fire pumps — engineered to meet NFPA 20 requirements for commercial, industrial, and high-rise applications."
      },
      {
        slug: "submersible-pumps",
        title: "Submersible Pumps",
        image: "/submersible_pump_sewage_1776253032452.png",
        description: "Durable submersible pumps for dewatering, sewage, drainage, and deep well applications. Corrosion-resistant construction with high-efficiency motors for reliable underground performance."
      },
      {
        slug: "booster-pumps",
        title: "Booster Pumps",
        image: "/placeholders/Product/p7.jpg",
        description: "Compact, high-pressure booster systems for municipal water distribution, building water supply, and irrigation networks. Variable speed drive options for energy savings."
      }
    ],
    fittings: [
      "Malleable Iron Fittings — Galvanized and black, threaded fittings conforming to ASME B16.3",
      "Grooved Fittings & Couplings — Quick-connect solutions for fire protection, HVAC, and industrial piping",
      "Flanges — Slip-on, weld-neck, blind, and socket-weld flanges per ASME B16.5 / B16.47",
      "Strainers & Filters — Y-strainers, basket strainers, and duplex strainers for pipeline protection"
    ]
    */
  },
  industries: [
...

    {
      ...
      description: "Efficient water management starts with reliable flow control. Our butterfly valves and check valves help agricultural operations maximize water delivery while minimizing waste — from drip irrigation networks to large-scale canal systems.",
      /* keyProducts: "Butterfly Valves · Foot Valves · Centrifugal Irrigation Pumps · Booster Pump Systems" */
      keyProducts: "Butterfly Valves · Foot Valves"
    },
    {
      ...
      description: "When lives are on the line, there's no room for compromise. Jinjieber's UL/FM listed fire protection valves are installed in commercial buildings, industrial facilities, airports, and high-rise towers worldwide. Every product undergoes rigorous third-party testing and certification.",
      /* keyProducts: "UL/FM OS&Y Gate Valves · Alarm Check Valves · Deluge Valves · Fire Pump Packages · Indicator Posts" */
      keyProducts: "UL/FM OS&Y Gate Valves · Alarm Check Valves · Deluge Valves · Indicator Posts"
    },
    {
  ...
  globalPresence: [
    {
      ...
      /* description: "Our state-of-the-art manufacturing campus houses advanced foundries, CNC machining centers, automated assembly lines, and a full-service quality lab. With over 500 skilled engineers and production specialists, this is where world-class valves and pumps are born." */
      description: "Our state-of-the-art manufacturing campus houses advanced foundries, CNC machining centers, automated assembly lines, and a full-service quality lab. With over 500 skilled engineers and production specialists, this is where world-class valves are born."
    },
    {
      title: "North America — Sales & Distribution Center",
      description: "Strategically located to serve the United States and Canada, our North America operation provides local inventory, technical sales support, and rapid logistics — so you get what you need, when you need it."
    },
    {
      title: "Middle East — Regional Partnership Hub",
      description: "With long-standing partnerships across Saudi Arabia, UAE, Qatar, Kuwait, and beyond, our Middle East operations provide on-the-ground project support for the region's massive oil & gas, desalination, and infrastructure projects."
    },
    {
      title: "Europe — Engineering & Compliance Office",
      description: "Our European office ensures all products meet EN, DIN, BS, and PED standards, providing localized technical support and certification management for the European market."
    }
  ],
  whyChooseUs: [
    { advantage: "35+ Years of Experience", meaning: "Deep metallurgical knowledge and proven manufacturing processes refined over decades" },
    { advantage: "Vertically Integrated", meaning: "Casting, forging, machining, assembly, testing, and coating — all in-house for complete quality control" },
    { advantage: "Global Certifications", meaning: "ISO 9001 · ISO 14001 · CE · API 6D · API 600 · UL/FM · AWWA · PED · NSF 61" },
    { advantage: "Custom Engineering", meaning: "OEM/ODM capabilities with dedicated R&D team for project-specific solutions" },
    { advantage: "Competitive Pricing", meaning: "Direct-from-manufacturer pricing without sacrificing quality or compliance" },
    { advantage: "Fast Lead Times", meaning: "Large standard inventory + rapid custom production to meet urgent project timelines" },
    { advantage: "After-Sales Support", meaning: "Dedicated account managers, technical assistance, and warranty support in your time zone" }
  ],
  certifications: [
    "ISO 9001:2015 — Quality Management System",
    "ISO 14001:2015 — Environmental Management System",
    "API 6D / API 600 / API 602 / API 603 — American Petroleum Institute Standards",
    "CE / PED (97/23/EC) — European Pressure Equipment Directive",
    "UL / FM Approved — Fire Protection Product Certification",
    "AWWA C509 / C515 / C504 — American Water Works Association Standards",
  ...
  capabilities: {
    ...
    assembly: {
      ...
      details: [
        ...
        "Expert technicians trained in high-spec industrial valve assembly"
      ]
    },
    testing: {
  ...
  testimonials: [
    {
      quote: "Jinjieber has been our go-to valve supplier for over 15 years. Their quality is consistently excellent, and their team truly understands the requirements of municipal water infrastructure projects.",
      name: "Water Utility Director",
      role: "Texas, USA"
    },
    {
      quote: "We've sourced fire protection valves from multiple suppliers. Jinjieber stands out for their UL/FM compliance, competitive pricing, and ability to deliver large orders on tight schedules.",
      name: "Fire Protection Contractor",
      role: "Dubai, UAE"
    },
    {
      quote: "From custom valve engineering to final delivery at our European warehouse, Jinjieber handles the entire process seamlessly. They are a true manufacturing partner, not just a supplier.",
      name: "Procurement Manager",
      role: "Industrial Distributor, Germany"
    },
    {
      quote: "Their investment in modern CNC equipment and testing facilities gives us confidence that every valve meets spec. In the oil and gas business, you can't afford to cut corners — and Jinjieber never does.",
      name: "Project Engineer",
      role: "EPC Contractor, Saudi Arabia"
    }
  ],
  contact: {
    ...
    description: "Whether you need a single prototype valve or custom project solutions, our team is ready to help. Tell us about your project and receive a competitive quote within 24 hours.",
